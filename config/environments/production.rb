...
Rails.application.configure do
  ...
  # Set SUPPORT_UNENCRYPTED_DATA=true if you need to re-run encryption migration
  config.active_record.encryption.support_unencrypted_data = ENV["SUPPORT_UNENCRYPTED_DATA"] == "true"
