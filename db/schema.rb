...
ActiveRecord::Schema[8.1].define(version: 2026_02_04_145415) do
  ...
  create_table "transcription_jobs", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.integer "user_job_number", null: false
    t.integer "year_hint"
    ...
    t.index ["user_id", "user_job_number"], name: "index_transcription_jobs_on_user_id_and_user_job_number", unique: true
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "email_preference", default: "none", null: false
    t.string "entry_retention", default: "days_30", null: false
    t.string "name"
